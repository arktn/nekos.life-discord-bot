...
module.exports = {
    ...
    execute(client, message, args){
        if (message.guild) {
            ...
            .setTitle('Help')
            .setColor('7289da')
            .setDescription(`You want to create a discord bot like this yourself?\n[Check out our Github page!](https://github.com/fez6/nekos.life-discord-bot)`)
            .addField('List of commands', prefix + 'commands')
            .setFooter('Made with 💖 and discord.js by fez', client.user.displayAvatarURL({ format: 'png', dynamic: true, size: 1024 }))
